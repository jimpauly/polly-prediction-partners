...
Four Quadrants Equal sizes and dimensions of the viewport:

Quadrant I: Blank space
Quadrant II: All UI elements
Quadrant III: Blank space
Quadrant IV: Blank Space

Blank spaces are only one color pulling the state or rules from the theme and mode

After all regions and their components fully fit, are features, and function in Quadrant II, the size of my phone screen up to my laptop screen, the remaining space will have more to develop with.
...
└── Illumination Switchboard
    ...
    │   ├── flip switch housing
    │   ├── indicator light
    │   └── nixie tube readout (2‑digit)
    ├── Master switch + dimmer
    │   ├── flip switch housing
    │   ├── indicator light
    │   ├── rotary dimmer dial
    │   └── nixie tube readout (2‑digit)
    ├── Text channel switches + dimmer
    │   ├── primary text switch housing
    │   ├── primary text indicator light
    │   ├── primary text dimmer dial
    │   ├── primary text nixie tube readout
    │   ├── secondary text switch housing
    │   ├── secondary text indicator light
    │   ├── secondary text dimmer dial
    │   └── secondary text nixie tube readout
    ├── Bars channel switches + dimmer
    │   ├── primary bar switch housing
    │   ├── primary bar indicator light
    │   ├── primary bar dimmer dial
    │   ├── primary bar nixie tube readout
    │   ├── secondary bar switch housing
    │   ├── secondary bar indicator light
    │   ├── secondary bar dimmer dial
    │   └── secondary bar nixie tube readout
    ├── Flood channel switch + dimmer
    │   ├── switch housing
    │   ├── indicator light
    │   ├── dimmer dial
    │   └── nixie tube readout
    └── Display channel switch + dimmer
        ├── switch housing
        ├── indicator light
        ├── dimmer dial
        └── nixie tube readout
...
└── Hangar Bay
    ...
    │   │   │   ├── emoji + name header
    │   │   │   ├── telegraph switch component
    │   │   │   │   ├── AUTO panel
    │   │   │   │   ├── STANDBY panel
    │   │   │   │   ├── OFF panel
    │   │   │   │   └── mode indicator lights for each
    │   └── bottom nameplate
    ├── P/L MFD card
    │   ├── Y-axis scale buttons (5)
    │   ├── Line chart area
    │   ├── X-axis timeframe buttons (5)
    └── Connect API Keys card
        ├── card header
        ├── mode selector
        ├── API key input field
        ├── Double heightRSA key textarea
        └── connect button
        └── Forget keys button
...
│   │   └── Daily P/L widget
│   ├── Top‑Level Nav
│   │   ├── pill buttons (Crypto, Sports, etc.)
│   │   ├── back/forward history buttons
│   │   ├── collapse/expand toggle
│   │   └── icons (optional)
│   ├── Secondary Nav / Tags
│   │   ├── tag pills (BTC, ETH, SOL, …)
│   │   └── scrolling container
│   ├── Filter Controls
│   │   ├── Volume dropdown
│   │   ├── Frequency dropdown
...
GLOBAL
└── Viewport / Theme / Illumination / Toast / WebSocket
