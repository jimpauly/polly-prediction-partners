...
(function () {
  ...
  var THEME_COLORS = {
    ...
    "gen7-cockpit":   { light: { bg: "#c8ceaf", fg: "#1e2a10", accent: "#4a7c2e" }, dark: { bg: "#111a0e", fg: "#33ff33", accent: "#33ff33" } },
    "ussr-cockpit":   { light: { bg: "#c8bba6", fg: "#2a1008", accent: "#cc2200" }, dark: { bg: "#1a100a", fg: "#ff6633", accent: "#ff2200" } },
    "neon-vice-1985": { light: { bg: "#ffe4f0", fg: "#2a0a2a", accent: "#ff1493" }, dark: { bg: "#19002a", fg: "#ffe0f0", accent: "#ff1493" } },
    ...
    "ledger-1920":    { light: { bg: "#ecdcbe", fg: "#2a1e0c", accent: "#6a4a1e" }, dark: { bg: "#221a0e", fg: "#e0d0a8", accent: "#c89840" } },
    ...
    "phosphor":       { light: { bg: "#d0e8d0", fg: "#0a2a0a", accent: "#1a8a1a" }, dark: { bg: "#001400", fg: "#33ff33", accent: "#33ff33" } },
    ...
    "dreamcore":      { light: { bg: "#f0e4ff", fg: "#30204a", accent: "#b060d0" }, dark: { bg: "#1c1028", fg: "#e8d8f8", accent: "#d080f0" } },
